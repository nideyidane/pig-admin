...
export const getMessageList = (params) => {
	return axios.get('pig-manage/sysInfo/list', {
		params: params
	}).then((res) => {
		return res.data;
	})
...
export const pushMessage = (params) => {
	return axios.post('pig-manage/sysInfo/push', params, { timeout: 1000 * 60 * 1 }).then((res) => {
		return res.data;
	})
}
// -----------------消息增加-------------------------------
export const addInfor = (params) => {
	return axios.post('pig-manage/sysInfo/add', params, { timeout: 1000 * 60 * 1 }).then((res) => {
		return res.data;
	})
}
// -----------------消息删除-------------------------------
export const deleteMessage = (params) => {
	return axios.post('pig-manage/sysInfo/delete', params, { timeout: 1000 * 60 * 1 }).then((res) => {
		return res.data;
	})
}
// -----------------群组选择-------------------------------
